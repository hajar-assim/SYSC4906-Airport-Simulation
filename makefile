...
plane_message.o: data_structures/plane_message.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) data_structures/plane_message.cpp -o build/plane_message.o
...
main_control_tower_test.o: test/main_control_tower_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_control_tower_test.cpp -o build/main_control_tower_test.o
...
main_runway_test.o: test/main_runway_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_runway_test.cpp -o build/main_runway_test.o

main_selector_test.o: test/main_selector_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_selector_test.cpp -o build/main_selector_test.o

main_storage_bay_test.o: test/main_storage_bay_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_storage_bay_test.cpp -o build/main_storage_bay_test.o

main_merger_test.o: test/main_merger_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_merger_test.cpp -o build/main_merger_test.o

main_coupled_test.o: test/main_coupled_test.cpp
	$(CC) -g -c $(CFLAGS) $(INCLUDECADMIUM) test/main_coupled_test.cpp -o build/main_coupled_test.o
